...
SELECT id, username, password, role, created_at FROM users WHERE id = $1 LIMIT 1
`
...
SELECT id, username, password, role, created_at FROM users ORDER BY id LIMIT $1 OFFSET $2
`
